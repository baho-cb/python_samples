...
This is a feed-forward fully connected neural net trained to predict the interaction
energy of a pair of rigid body.
...
Don't go larger than 130x15 for neural net size 
"""
...
for i in range(N_epochs):
    ...
    if i % save_freq == 0:
        model_name = './models/model_NE%d_W%d_D%d.pth' %(i,width,depth)
